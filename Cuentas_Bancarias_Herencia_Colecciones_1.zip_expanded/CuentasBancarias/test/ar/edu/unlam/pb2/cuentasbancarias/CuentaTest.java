...
public class CuentaTest {
	...
	public void queAlCrearLacuentaSuSaldoSeaCero() {
		/*
		 * (Given) some context (When) some action is carried out (Then) a particular
		 * set of observable consequences should obtain An example:
		 * 
		 * Given my bank account is in credit, and I made no withdrawals recently, When
		 * I attempt to withdraw an amount less than my card’s limit, Then the
		 * withdrawal should complete without errors or warnings
		 */
